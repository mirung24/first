...
<head>
	...
	<link rel="stylesheet" href="/chain/css/category.css">
</head>
<body>
	...
	<div class="modal-wrap3" style="display: none;">
		<div class="pop3">
			...
			<ul class="category-wrap">
				<li class="category pointer"><input class="inp-cbx" id="use2" name="use" type="checkbox" checked/>
	...
	<script src="/chain/js/category.js"></script>
</body>
</html>