...
<head>
	...
	<link rel="stylesheet" href="/chain/css/product.css">
</head>
<body>
...
<!-- 					<div class="box p-0 d-flex justify-content-between">
					...
					<ul>
						<ul>
							...
							<li class="pop-list"><span>카테고리</span>
								<input type="text" value="" class="form-control pop-link4" id="d_prodcate" name="d_prodcate" maxlength="0">
							</li>
							...
							<li class="pop-list"><span>메모</span>
								<textarea name="d_prodremarks" id="d_prodremarks" cols="55" rows="12"></textarea></li>
						</ul>
					</ul>
							...
							<table class="table table-hover table-striped text-center mb-0">
								<thead>
									<tr>
										...
										<th class="fixedHeader">제품아이디s</th>
									</tr>
								</thead>
		...
		<div class="pop2">
			...
			<div class="pop-cont">
				<ul>
					...
					<li class="pop-list"><span>카테고리</span><input type="text" value="" class="form-control Kategorie category pop-link4" maxlength="0">
	...
	<script src="/chain/js/product.js"></script>
</body>
</html>